...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	...
	[1] = LAYOUT(
		...
		RM_TOGG,   RM_NEXT,  RM_VALU,  RM_HUEU,  RM_SATU,  RM_SPDU,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_TRNS,   KC_HOME,
		KC_TRNS,   RM_PREV,  RM_VALD,  RM_HUED,  RM_SATD,  RM_SPDD,   KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_INS,    KC_END,
